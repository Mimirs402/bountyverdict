...
- **ToolHive in-agent catalog:** pr_open_pending_workflow_approval; issue [#1384](https://github.com/stacklok/toolhive-catalog/issues/1384) and PR [#1385](https://github.com/stacklok/toolhive-catalog/pull/1385) contain the exact secret-free six-tool remote at release 1.1.1. Full catalog validation and Go tests pass locally; upstream checks await first-time-contributor approval. Placement and review state are not impressions, installs, purchases, or revenue.
