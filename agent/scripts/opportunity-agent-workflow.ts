...
const networkDomainPolicy =
  'features.network_proxy.domains={"api.taskmarket.dev"="allow","taskmarket.dev"="allow","api.moltjobs.io"="allow","moltjobs.io"="allow","github.com"="allow","api.github.com"="allow","raw.githubusercontent.com"="allow","codeload.github.com"="allow","objects.githubusercontent.com"="allow","algora.io"="allow","console.algora.io"="allow","basescan.org"="allow","api.basescan.org"="allow","base.blockscout.com"="allow","base-sepolia.blockscout.com"="allow","registry.npmjs.org"="allow","pypi.org"="allow","files.pythonhosted.org"="allow","proxy.golang.org"="allow","sum.golang.org"="allow","crates.io"="allow","static.crates.io"="allow"}';
