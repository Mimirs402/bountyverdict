...
const MCP_SERVER_VERSION = "1.1.2";
...
const TOOL_DESCRIPTIONS: Record<ToolName, string> = {
  check_github_bounty: `${unsignedPreviewGuidance(PRODUCT_CATALOG.single.priceUsd)} Use before coding one public GitHub bounty issue to get an evidence-linked AVOID, CAUTION, or VIABLE claimability verdict. For 2-10 candidates use rank_github_bounties. Read-only; never invent arguments. Sample: https://bountyverdict-agent-production.mimirslab.workers.dev/api/sample.`,
  rank_github_bounties: `${unsignedPreviewGuidance(PRODUCT_CATALOG.portfolio.priceUsd)} Use to choose the best candidate from 2-10 public GitHub bounty issues with full verdicts, evidence, ranking, and partial failures. For one issue use check_github_bounty. Read-only; never invent arguments. Sample: https://bountyverdict-agent-production.mimirslab.workers.dev/api/portfolio/sample.`,
