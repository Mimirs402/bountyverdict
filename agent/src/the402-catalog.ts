...
export const THE402_LISTINGS: ReadonlyArray<{
...
}> = Object.freeze([
  {
    ...
    name: "BountyVerdict",
    description: "Is this GitHub issue bounty still available, and can I claim it? Check whether a public GitHub bounty is open, unclaimed, and worth pursuing before coding. Verify live eligibility, reward provenance, claimability, assignments, explicit soft locks, trusted Algora claim status, rewarded or unverified listings, competing pull requests, and repository AI-use rules. Returns AVOID, CAUTION, or VIABLE with public evidence and explicit truncation. Documentation: https://mimirs402.github.io/bountyverdict/agents.html",
    price: "$0.05",
    agent_price: "$0.053",
  ...
  },
  {
    ...
    description: "Which GitHub bounty should I choose? Compare GitHub bounties and rank two to ten public bounty issues using the full evidence-linked due-diligence check, preserving partial failures and selecting the strongest non-AVOID option. Documentation: https://mimirs402.github.io/bountyverdict/agents.html",
    price: "$0.40",
    agent_price: "$0.42",
  ...
  },
  {
    ...
    description: "Check repository instructions before coding. Audit AGENTS.md, CLAUDE.md, GEMINI.md, Copilot, Cursor, and SKILL.md surfaces in a public GitHub repository at an immutable commit, with portability checks for Codex, Claude Code, Gemini CLI, GitHub Copilot, and Cursor. Returns READY, REVIEW, or REPAIR with evidence-linked fixes; instant and read-only, with no repository clone or code execution.",
    price: "$0.03",
    agent_price: "$0.032",
    tags: [
      "github",
  ...
  },
  {
    ...
    description: "Will this MCP schema update break existing agents? Compare MCP tool schemas and complete baseline/current tools/list snapshots, then return an exact-hash compatibility verdict without fetching or invoking tools. Documentation and strict input contract: https://mimirs402.github.io/bountyverdict/agents.html",
    price: "$0.02",
    agent_price: "$0.021",
