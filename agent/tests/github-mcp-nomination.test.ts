...
test("GitHub nomination is fixed to the official registry route and business identity", () => {
  ...
  assert.match(GITHUB_MCP_NOMINATION.body, /io\.github\.Mimirs402\/bountyverdict@1\.1\.11/);
...
test("nomination receipt identity is bound to the fixed content contract", () => {
  ...
  assert.equal(nominationContractSha256(), "decd679cc212fb147c1a46b13b94a593ceff9a3e5112f1fe95477ca77457da27");
});
